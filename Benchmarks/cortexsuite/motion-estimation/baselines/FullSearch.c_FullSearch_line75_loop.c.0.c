...
extern int yt;
extern int yc;
extern double * __restrict__ block_ref;
typedef struct {
double *data;
int x_length;
int y_length;}Image;
extern Image * __restrict__ img_ref;
extern int ii;
...
#pragma scop
  for (__i_0__ = -SearchLimit; __i_0__ <= SearchLimit - 1; __i_0__ += 1) {
    for (__j_2__ = -SearchLimit; __j_2__ <= SearchLimit - 1; __j_2__ += 1) {{
        xt = xc + __j_2__;
        yt = yc + __i_0__;
      }
      block_ref = img_ref -> data + yt * img_ref -> x_length + xt;
{
      ...
      for (__ii_3__ = 0; __ii_3__ <= BlockSize - 1; __ii_3__ += 1) {
        for (__jj_4__ = 0; __jj_4__ <= BlockSize - 1; __jj_4__ += 1) {
