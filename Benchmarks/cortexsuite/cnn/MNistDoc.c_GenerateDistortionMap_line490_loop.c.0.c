...
extern double * __restrict__ uniformH;
extern double * __restrict__ uniformV;
...
#pragma scop
  for (__col_0__ = 0; __col_0__ <= cmnistdoc -> m_cCols - 1; __col_0__ += 1) {
    for (__row_3__ = 0; __row_3__ <= cmnistdoc -> m_cRows - 1; __row_3__ += 1) {{
        fConvolvedH = 0.0;
        fConvolvedV = 0.0;
      }
