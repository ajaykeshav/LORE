...
#pragma scop
  for (__jt_0__ = 2; __jt_0__ <= 4; __jt_0__ += tile_size) {
    for (__it_1__ = 2; __it_1__ <= 2; __it_1__ += tile_size) {
      for (__j_2__ = __jt_0__; __j_2__ <= 3; __j_2__ += 1) {
        for (__i_3__ = __it_1__; __i_3__ <= 5; __i_3__ += 1) {
          for (__jj_4__ = - 2; __jj_4__ <= 2; __jj_4__ += 1) {
            out[__i_3__ + __j_2__ * n] += weight[0 + 2][__jj_4__ + 2] * in[__i_3__ + (__j_2__ + __jj_4__) * n];
          }
          for (__ii_5__ = - 2; __ii_5__ <= 5; __ii_5__ += 1) {
