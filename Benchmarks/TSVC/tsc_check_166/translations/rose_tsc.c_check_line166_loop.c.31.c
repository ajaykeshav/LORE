...
/* fringe = iter_count%unroll_factor==0 ? 0:unroll_factor*step */
      ...
      for (__i_0__ = _lt_var___i_0__; __i_0__ <= 74; __i_0__ += 8) {
        suma += a[__i_0__];
{
          suma += a[__i_0__ + 1];
        }
...
/* fringe = iter_count%unroll_factor==0 ? 0:unroll_factor*step */
      ...
      for (__i_0__ = _lt_var___i_0__; __i_0__ <= 201; __i_0__ += 8) {
        sumb += b[__i_0__];
{
          sumb += b[__i_0__ + 1];
        }
...
/* fringe = iter_count%unroll_factor==0 ? 0:unroll_factor*step */
      ...
      for (__i_0__ = _lt_var___i_0__; __i_0__ <= 308; __i_0__ += 8) {
        sumc += c[__i_0__];
{
          sumc += c[__i_0__ + 1];
        }
...
/* fringe = iter_count%unroll_factor==0 ? 0:unroll_factor*step */
      ...
      for (__i_0__ = _lt_var___i_0__; __i_0__ <= 101; __i_0__ += 8) {
        sumd += d[__i_0__];
{
          sumd += d[__i_0__ + 1];
        }
...
/* fringe = iter_count%unroll_factor==0 ? 0:unroll_factor*step */
      ...
      for (__i_0__ = _lt_var___i_0__; __i_0__ <= 263; __i_0__ += 8) {
        sume += e[__i_0__];
{
          sume += e[__i_0__ + 1];
        }
